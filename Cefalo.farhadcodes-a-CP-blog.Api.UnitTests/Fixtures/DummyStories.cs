...
namespace Cefalo.farhadcodes_a_CP_blog.Api.UnitTests.Fixtures
{
    public class DummyStories
    {
        ...
        public ShowStoryDTO dummyShowStoryDTO, emptyShowStoryDTO;
        public List<ShowStoryDTO> dummyShowStoryDTOList;
        ...
        public DummyStories()
        {
            ...
            // showstorydtolist
            dummyShowStoryDTOList = new List<ShowStoryDTO> { dummyShowStoryDTO };
            dummyShowStoryDTOList.Add(dummyShowStoryDTO);
